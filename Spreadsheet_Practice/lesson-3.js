...
var Lesson3 = (function () {
  ...
  var exercises = [
    {
      ...
      instruction: `<p>In this lesson, we'll use spreadsheets to study a <strong>change equation</strong>, which describes how a quantity changes over time.</p>
    ...
    },
    {
      ...
      validate: function () {
        ...
        const correctDt =
          Math.abs(dt7.result - 1) < 0.01 && Math.abs(dt8.result - 1) < 0.01;

        // X should be approaching 40 by row 8
        const approachingEquilibrium = x8.result > 39 && x8.result < 40.5;
  ...
  function showLessonIntroduction() {
    var introduction = `
        ...
        <p>Welcome to Lesson 3! In this lesson, you'll learn advanced spreadsheet modeling:</p>
        <ul>
            <li><strong>Differential Equations:</strong> Modeling rates of change</li>
            <li><strong>Iterative Calculations:</strong> Using previous results in new calculations</li>
            <li><strong>Scientific Modeling:</strong> Applying math to biological systems</li>
        </ul>
