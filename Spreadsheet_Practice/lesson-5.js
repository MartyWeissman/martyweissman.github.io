  ...
  var exercises = [
    {
      ...
      instruction: `<p>In this lesson, we'll explore <strong>delay equations</strong> and how to implement them in spreadsheets.</p>
    ...
    },
    {
      ...
      getErrorMessage: function () {
        ...
        if (
          !dxFormula.formula.toLowerCase().replace(/\s+/g, "").includes("b2")
        ) {
